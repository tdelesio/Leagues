...
public class MakePicksPanel extends AbstractBasePanel
{
	...
	public MakePicksPanel(String id, final IModel<Week> model)
	{
        ...
        MakePickDataView makePickDataView = new MakePickDataView("pickRow", dataProvider)
        {
	...
	private void handleDoublePickDropDown(AjaxRequestTarget target, IModel<Week> model, Picks pick)
	{
		...
		if (doublePicks!=null&&doublePicks.getGame()!=null&&doublePicks.getGame().hasGameStarted())
			return;
