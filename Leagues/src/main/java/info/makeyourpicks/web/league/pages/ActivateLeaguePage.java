 ...
 * @author PRC9041
 */
public class ActivateLeaguePage extends LeagueMemberWebPage {
	...
	public ActivateLeaguePage()
	{
		...
		Form creditcardForm = new Form("form", new CompoundPropertyModel(model))
		{
			...
			protected void onSubmit() {
				...
				PaypalHelper paypalHelper = new PaypalHelper(((LeagueWebApplication)getApplication()).isPaypalSandbox());
